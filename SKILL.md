---
name: auto
description: Use when user says "새 프로젝트", "시작해줘", "자동으로 끝까지", "자동 파이프라인", "auto", "FEATURE", "BUGFIX", "버그 수정", "기능 추가" — Self-Improve SDLC: parallel execution, Context7 enrichment, self-improve loop, dispatch-based batching. Supports --resume, --status, --score, --learn. Auto-merges plan-studio/spec-studio docs when plan.md missing.
